package com.dugaroverseas.features.logoutsync.presentation
...
import com.dugaroverseas.app.AppDatabase
...
import com.dugaroverseas.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.dugaroverseas.features.billing.api.AddBillingRepoProvider
import com.dugaroverseas.features.billing.model.AddBillingInputParamsModel
...
import com.dugaroverseas.features.dashboard.presentation.ReasonDialog
...
import com.dugaroverseas.features.document.model.AddEditDocumentInputParams
import com.dugaroverseas.features.document.model.DocumentAttachmentModel
...
import com.dugaroverseas.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.dugaroverseas.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.dugaroverseas.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.dugaroverseas.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.dugaroverseas.features.orderhistory.model.*
...
import com.dugaroverseas.features.quotation.model.AddQuotInputModel
import com.dugaroverseas.features.shopdetail.presentation.api.EditShopRepoProvider
import com.dugaroverseas.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.dugaroverseas.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.dugaroverseas.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.dugaroverseas.features.timesheet.model.AddTimeSheetInputModel
import com.dugaroverseas.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.dugaroverseas.features.viewAllOrder.model.AddOrderInputParamsModel
import com.dugaroverseas.features.viewAllOrder.model.AddOrderInputProductList
import com.dugaroverseas.mappackage.SendBrod
import com.dugaroverseas.widgets.AppCustomTextView
import com.dugaroverseas.MonitorService
import com.dugaroverseas.MySingleton
...
import com.dugaroverseas.features.addshop.presentation.ShopExtraContactReq
...
import com.dugaroverseas.features.login.model.GetConcurrentUserResponse
import com.dugaroverseas.features.login.model.WhatsappApiData
import com.dugaroverseas.features.performance.model.Gps_status_list
import com.dugaroverseas.features.performance.model.UpdateGpsInputListParamsModel
import com.dugaroverseas.features.returnsOrder.ReturnProductList
import com.dugaroverseas.features.returnsOrder.ReturnRequest
import com.dugaroverseas.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdugaroverseaslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdugaroverseaslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xdugaroverseaslogsample/log.zip").path);
